package org.example.OnlineShop.constants;

public class Pages {
    public static final String ADMIN_PHONES = "admin-phones";
    public static final String ADMIN_EDIT_PHONE = "admin-edit-phone";
    public static final String ADMIN_ADD_PHONE = "admin-add-phone";
