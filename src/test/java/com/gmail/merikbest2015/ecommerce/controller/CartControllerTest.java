...
@Sql(value = {"/sql/create-phones-before.sql", "/sql/create-user-before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = {"/sql/create-user-after.sql", "/sql/create-phones-after.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
public class CartControllerTest {
    ...
    @Test
    @WithUserDetails(USER_EMAIL)
    @DisplayName("[300] POST /cart/add - Add Phone To Cart")
    ...
    @Test
    @WithUserDetails(USER_EMAIL)
    @DisplayName("[300] POST /cart/remove - Remove Phone From Cart")
    public void removePhoneFromCart() throws Exception {
